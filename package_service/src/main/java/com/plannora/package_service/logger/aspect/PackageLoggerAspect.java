package com.plannora.package_service.logger.aspect;

import com.plannora.package_service.logger.DTO.LogEvent;
import com.plannora.package_service.logger.client.LoggerClient;
import com.plannora.package_service.security.RequestContext;
...
public class PackageLoggerAspect {
     ...
     */
    @Around("execution(* com.plannora.package_service.controller..*(..))")
